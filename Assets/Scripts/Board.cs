...
public class Board : MonoBehaviour
{
    ...
    // Draws colored sphere for debugging purposes
    void OnDrawGizmos()
    {
    ...
    // Draws the Goal prefab(gameObject) at the given Node
    ...
    // Initialises the Nodes/drawing links
